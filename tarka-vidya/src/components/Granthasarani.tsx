...
export default function Granthasarani({
  ...
  const isStructuredText = selectedText?.id === "nyaya-sutras" || selectedText?.id === "tarka-sastram" || selectedText?.id === "tarkabhasha" || selectedText?.id === "laksana-sangraha" || selectedText?.id === "vaiseasika-sutras" || selectedText?.id === "padartha-dharmasamgraha" || selectedText?.id === "tarka-samgraha" || selectedText?.id === "karikavali" || selectedText?.id === "nyayasiddhantamuktavali" || selectedText?.id === "anandagiri-tarkasangraha" || selectedText?.id === "vyomavati" || selectedText?.id === "tattva-cintamani";
  ...
  const isStructuredTextB = selectedTextB?.id === "nyaya-sutras" || selectedTextB?.id === "tarka-sastram" || selectedTextB?.id === "tarkabhasha" || selectedTextB?.id === "laksana-sangraha" || selectedTextB?.id === "vaiseasika-sutras" || selectedTextB?.id === "padartha-dharmasamgraha" || selectedTextB?.id === "tarka-samgraha" || selectedTextB?.id === "karikavali" || selectedTextB?.id === "nyayasiddhantamuktavali" || selectedTextB?.id === "anandagiri-tarkasangraha" || selectedTextB?.id === "vyomavati" || selectedTextB?.id === "tattva-cintamani";
  ...
  useEffect(() => {
    ...
    const hasMatchingInitialSec = initialSectionId && (
      (selectedText.id === "tarka-samgraha" && initialSectionId.startsWith("tarkasamgraha")) ||
      (selectedText.id === "tarka-sastram" && initialSectionId.startsWith("tarka-")) ||
      (selectedText.id === "tarkabhasha" && initialSectionId.startsWith("tarkabhasha")) ||
      (selectedText.id === "laksana-sangraha" && initialSectionId.startsWith("laksana")) ||
      (selectedText.id === "vaiseasika-sutras" && initialSectionId.startsWith("vaiseasika")) ||
      (selectedText.id === "padartha-dharmasamgraha" && initialSectionId.startsWith("padartha")) ||
      (selectedText.id === "karikavali" && initialSectionId.startsWith("karikavali")) ||
      (selectedText.id === "anandagiri-tarkasangraha" && initialSectionId.startsWith("anandagiri-tarkasangraha")) ||
      (selectedText.id === "vyomavati" && initialSectionId.startsWith("vyomavati")) ||
      (selectedText.id === "tattva-cintamani" && initialSectionId.startsWith("tattva-cintamani")) ||
      (selectedText.id === "nyaya-sutras" && (initialSectionId.startsWith("sec") || initialSectionId.startsWith("chapter")))
    );

    if (selectedText.id === "tarka-samgraha") {
      setSelectedChapters([1, 2, 3, 4, 5, 6]);
      if (!hasMatchingInitialSec) {
        setSelectedSectionId("tarkasamgraha-1");
      }
      ...
      if (selectedText.id === "tarka-sastram") {
        ...
        if (!hasMatchingInitialSec) setSelectedSectionId("tarka-1");
      } else if (selectedText.id === "tarkabhasha") {
        setSelectedChapters([1, 2, 3]);
        if (!hasMatchingInitialSec) setSelectedSectionId("tarkabhasha-1");
      } else if (selectedText.id === "laksana-sangraha") {
        setSelectedChapters([1, 2, 3]);
        if (!hasMatchingInitialSec) setSelectedSectionId("laksana-1");
      } else if (selectedText.id === "vaiseasika-sutras") {
        setSelectedChapters([1, 2, 3, 4, 5]);
        if (!hasMatchingInitialSec) setSelectedSectionId("vaiseasika-1");
      } else if (selectedText.id === "padartha-dharmasamgraha") {
        setSelectedChapters([1, 2, 3, 4]);
        if (!hasMatchingInitialSec) setSelectedSectionId("padartha-1");
      } else if (selectedText.id === "karikavali" || selectedText.id === "nyayasiddhantamuktavali") {
        setSelectedChapters([1, 2, 3]);
        if (!hasMatchingInitialSec) setSelectedSectionId("karikavali-1");
      } else if (selectedText.id === "anandagiri-tarkasangraha") {
        setSelectedChapters([1, 2, 3, 4, 5]);
        if (!hasMatchingInitialSec) setSelectedSectionId("anandagiri-tarkasangraha-1");
      } else if (selectedText.id === "vyomavati") {
        setSelectedChapters([1, 2, 3, 4, 5, 6, 7]);
        if (!hasMatchingInitialSec) setSelectedSectionId("vyomavati-1");
      } else if (selectedText.id === "tattva-cintamani") {
        setSelectedChapters([1, 4]);
        if (!hasMatchingInitialSec) setSelectedSectionId("tattva-cintamani-1");
      } else if (selectedText.id === "nyaya-sutras") {
        setSelectedChapters([1, 2, 3, 4, 5]);
        if (!hasMatchingInitialSec) setSelectedSectionId("sec-intro");
      }
    }
  }, [selectedText]);
  ...
  useEffect(() => {
    ...
    if (selectedTextB.id === "tarka-samgraha") {
      setSelectedChaptersB([1, 2, 3, 4, 5, 6]);
      setSelectedSectionIdB("tarkasamgraha-1");
      setSelectedCommentaryB("dipika");
    } else {
      setSelectedCommentaryB("all");
      if (selectedTextB.id === "tarka-sastram") {
        setSelectedChaptersB([1, 2, 3]);
        setSelectedSectionIdB("tarka-1");
      } else if (selectedTextB.id === "tarkabhasha") {
        setSelectedChaptersB([1, 2, 3]);
        setSelectedSectionIdB("tarkabhasha-1");
      } else if (selectedTextB.id === "laksana-sangraha") {
        setSelectedChaptersB([1, 2, 3]);
        setSelectedSectionIdB("laksana-1");
      } else if (selectedTextB.id === "vaiseasika-sutras") {
        setSelectedChaptersB([1, 2, 3, 4, 5]);
        setSelectedSectionIdB("vaiseasika-1");
      } else if (selectedTextB.id === "padartha-dharmasamgraha") {
        setSelectedChaptersB([1, 2, 3, 4]);
        setSelectedSectionIdB("padartha-1");
      } else if (selectedTextB.id === "karikavali" || selectedTextB.id === "nyayasiddhantamuktavali") {
        setSelectedChaptersB([1, 2, 3]);
        setSelectedSectionIdB("karikavali-1");
      } else if (selectedTextB.id === "anandagiri-tarkasangraha") {
        setSelectedChaptersB([1, 2, 3, 4, 5]);
        setSelectedSectionIdB("anandagiri-tarkasangraha-1");
      } else if (selectedTextB.id === "vyomavati") {
        setSelectedChaptersB([1, 2, 3, 4, 5, 6, 7]);
        setSelectedSectionIdB("vyomavati-1");
      } else if (selectedTextB.id === "tattva-cintamani") {
        setSelectedChaptersB([1, 4]);
        setSelectedSectionIdB("tattva-cintamani-1");
      } else if (selectedTextB.id === "nyaya-sutras") {
        setSelectedChaptersB([1, 2, 3, 4, 5]);
        setSelectedSectionIdB("sec-intro");
      }
    }
  }, [selectedTextB]);
  ...
  const getCommentaryHeadersForText = (textId: string): string[] => {
    let source: NyayaSection[] = [];
    if (textId === "tarka-sastram") source = TARKASASTRAS_SECTIONS;
    else if (textId === "tarka-samgraha") source = TARKASAMGRAHA_SECTIONS;
    else if (textId === "tarkabhasha") source = TARKABHASHA_SECTIONS;
    else if (textId === "laksana-sangraha") source = LAKSANA_SECTIONS;
    else if (textId === "vaiseasika-sutras") source = VAISESHIKA_SECTIONS;
    else if (textId === "padartha-dharmasamgraha") source = PADARTHA_SECTIONS;
    else if (textId === "karikavali" || textId === "nyayasiddhantamuktavali") source = KARIKAVALI_SECTIONS;
    else if (textId === "anandagiri-tarkasangraha") source = ANANDAGIRI_SECTIONS;
    else if (textId === "vyomavati") source = VYOMAVATI_SECTIONS;
    else if (textId === "tattva-cintamani") source = TATTVA_CINTAMANI_SECTIONS;
    else source = NYAYA_SECTIONS;
  ...
  const sectionsSource = 
    selectedText?.id === "tarka-sastram" 
      ? TARKASASTRAS_SECTIONS 
      : selectedText?.id === "tarka-samgraha"
      ? TARKASAMGRAHA_SECTIONS
      : selectedText?.id === "tarkabhasha"
      ? TARKABHASHA_SECTIONS
      : selectedText?.id === "laksana-sangraha"
      ? LAKSANA_SECTIONS
      : selectedText?.id === "vaiseasika-sutras"
      ? VAISESHIKA_SECTIONS
      : selectedText?.id === "padartha-dharmasamgraha"
      ? PADARTHA_SECTIONS
      : selectedText?.id === "karikavali" || selectedText?.id === "nyayasiddhantamuktavali"
      ? KARIKAVALI_SECTIONS
      : selectedText?.id === "anandagiri-tarkasangraha"
      ? ANANDAGIRI_SECTIONS
      : selectedText?.id === "vyomavati"
      ? VYOMAVATI_SECTIONS
      : selectedText?.id === "tattva-cintamani"
      ? TATTVA_CINTAMANI_SECTIONS
      : NYAYA_SECTIONS;
  ...
  useEffect(() => {
    const isValid = activeSections.some((sec) => sec.id === selectedSectionId);
    if (!isValid && activeSections.length > 0) {
      setSelectedSectionId(activeSections[0].id);
    }
  }, [selectedChapters, selectedSectionId, activeSections]);
  ...
  const sectionsSourceB = 
    selectedTextB?.id === "tarka-sastram" 
      ? TARKASASTRAS_SECTIONS 
      : selectedTextB?.id === "tarka-samgraha"
      ? TARKASAMGRAHA_SECTIONS
      : selectedTextB?.id === "tarkabhasha"
      ? TARKABHASHA_SECTIONS
      : selectedTextB?.id === "laksana-sangraha"
      ? LAKSANA_SECTIONS
      : selectedTextB?.id === "vaiseasika-sutras"
      ? VAISESHIKA_SECTIONS
      : selectedTextB?.id === "padartha-dharmasamgraha"
      ? PADARTHA_SECTIONS
      : selectedTextB?.id === "karikavali" || selectedTextB?.id === "nyayasiddhantamuktavali"
      ? KARIKAVALI_SECTIONS
      : selectedTextB?.id === "anandagiri-tarkasangraha"
      ? ANANDAGIRI_SECTIONS
      : selectedTextB?.id === "vyomavati"
      ? VYOMAVATI_SECTIONS
      : selectedTextB?.id === "tattva-cintamani"
      ? TATTVA_CINTAMANI_SECTIONS
      : NYAYA_SECTIONS;
  ...
  useEffect(() => {
    const isValid = activeSectionsB.some((sec) => sec.id === selectedSectionIdB);
    if (!isValid && activeSectionsB.length > 0) {
      setSelectedSectionIdB(activeSectionsB[0].id);
    }
  }, [selectedChaptersB, selectedSectionIdB, activeSectionsB]);
  ...
  return (
    <div className="space-y-6" id="granthasarani-module">
      ...
      {!focusMode && selectedText && (
        <div className="bg-[#FAF8F5] border-2 border-[#1A1A1A] p-4.5 rounded-none shadow-[3px_3px_0px_0px_rgba(26,26,26,1)] relative transition-all">
          <button
            onClick={() => setIsLibraryExpanded(!isLibraryExpanded)}
            className="w-full flex items-center justify-between text-xs font-serif font-black text-[#3B2314] uppercase tracking-wider py-1.5 cursor-pointer"
          >
            <span className="flex items-center gap-2">
              <BookOpen className="w-4.5 h-4.5 text-[#C25E3E]" />
              <span>Click to browse library & change treatise ({isLibraryExpanded ? "Collapse ▴" : "Expand ▾"})</span>
            </span>
            <span className="text-[10px] font-mono bg-white px-2.5 py-0.5 border border-stone-300">
              Active: {selectedText.title}
            </span>
          </button>

          {isLibraryExpanded && (
            <div className="mt-4 pt-4 border-t border-[#1A1A1A]/30 space-y-4 animate-fade-in text-left">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex gap-1 overflow-x-auto pb-1.5 custom-scrollbar">
                    {["All", "Nyāya", "Vaiśeṣika", "Navya-Nyāya", "Buddhist Logic", "Jaina Logic", "Syncretic"].map((school) => (
                      <button
                        key={school}
                  ...
                  return (
                    <div
                      ...
                      onClick={() => {
                        ...
                        const clickIsStructured = text.id === "nyaya-sutras" || text.id === "tarka-sastram" || text.id === "tarkabhasha" || text.id === "laksana-sangraha" || text.id === "vaiseasika-sutras" || text.id === "padartha-dharmasamgraha" || text.id === "tarka-samgraha" || text.id === "karikavali" || text.id === "nyayasiddhantamuktavali" || text.id === "anandagiri-tarkasangraha" || text.id === "vyomavati" || text.id === "tattva-cintamani";
                        if (!clickIsStructured) {
                          setSelectedSectionId("sec-intro");
                        }
                      }}
                      className={`p-3 border-2 cursor-pointer transition-all text-left ${
                        isActive
                          ? "bg-[#ECE0D1]/40 border-[#8C6239] shadow-inner"
                          : "bg-white border-stone-200 hover:border-[#1A1A1A] hover:bg-[#FAF8F5]/55"
                      }`}
                    >
              ...
              <div className="bg-[#FAF8F5] border-2 border-[#1A1A1A] px-4 py-2 font-black uppercase text-xs text-[#3B2314] flex justify-between items-center">
                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    if (txt) {
                      setSelectedText(txt);
                      const clickIsStructured = txt.id === "nyaya-sutras" || txt.id === "tarka-sastram" || txt.id === "tarkabhasha" || txt.id === "laksana-sangraha" || txt.id === "vaiseasika-sutras" || txt.id === "padartha-dharmasamgraha" || txt.id === "tarka-samgraha" || txt.id === "karikavali" || txt.id === "nyayasiddhantamuktavali" || txt.id === "anandagiri-tarkasangraha" || txt.id === "vyomavati" || txt.id === "tattva-cintamani";
                      if (!clickIsStructured) {
                        setSelectedSectionId("sec-intro");
                      }
                    }
